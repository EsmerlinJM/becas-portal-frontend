        ...
        <div className="login flex flex-col">
          ...
          <div className="flex flex-col justify-center mb-6">
            <input
              ...
              }  font-thin text-sm focus:outline-none border rounded px-6 py-3`}
              type="password"
            ...
            <button
              onClick={action}
              className=" rounded-3xl transition delay-75 azulbg text-white hover:bg-white border border-blue-900 hover:border-blue-800 hover:text-blue-800  px-16 py-3 cursor-pointer uppercase"
            >
              Guardar
            </button>
          </div>
