        ...
        <div className="left w-screen">
          ...
          <div className="busqueda p-4 h-96 flex flex-col lg:mt-12 lg:ml-52 lg:mr-32 justify-center mt-4 ml-16 mr-8">
            ...
            <h3 className="font-bold">Regístrate</h3>
              ...
              <h3 className="font-bold lg:text-2xl text-1xl" >de las próximas ofertas de
                becas</h3>
            </div>
            <p className="font-semibold mb-5 azul ">
              Siguiente convocatoria de becas nacionales: <span className='text-yellow-600'>31 de enero de 2022.</span>
            </p>
            <div>
              <InputSearchHome />
