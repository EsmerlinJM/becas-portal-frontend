    ...
    <Header2Natigation objNav={objNav}>
      <div className="notificaciones w-5/6 pt-3 m-auto grid grid-cols-1 gap-y-4 mb-4">
        <span className="flex justify-end">
          <button className="flex items-center space-x-1 bg-white text-xs text-gray-500 font-semibold border-2 py-2 px-4 rounded-3xl hover:bg-red-50 hover:border-red-300 transition">
