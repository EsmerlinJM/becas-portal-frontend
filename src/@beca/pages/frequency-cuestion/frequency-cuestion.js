        ...
        <div className="grid grid-cols-1 gap-2 font-semibold ">
          {FAQs.map((faq) => (
            <Disclosure>
              {({ open }) => (
                <>
                  <Disclosure.Button className="flex justify-between items-center w-full p-3 text-sm font-medium text-left text-white bg-blue-900 rounded hover:bg-blue-800 focus:outline-none focus-visible:ring focus-visible:ring-blue-500 focus-visible:ring-opacity-75 transition-all duration-200">
                    <span>{faq.title}</span>
                    <FaChevronDown
                      className={`${
                  ...
                  >
                    <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-gray-900 text-justify bg-white">
                      {faq.body}
                    </Disclosure.Panel>
                  </Transition>
                </>
...
const FAQs = [
  ...
  },
  {
    ...
    body: `
    a) Apoyar con ayuda económica y asesoramiento la preparación de los profesionales que necesita el país para impulsar el desarrollo económico y social.

    b) Promover el acceso, permanencia y conclusión de estudios superiores a partir del ofrecimiento y otorgamiento de diferentes tipos de becas y crédito educativo a estudiantes y profesionales para apoyar su formación integral.
    
    c) Promover el desarrollo profesional de los ciudadanos dominicanos a partir de ampliar el acceso al apoyo económico que contribuya a la mejor preparación de los profesionales y estudiantes dominicanos.
    
    d) Realizar convocatorias de becas nacionales e internacionales en coherencia con las necesidades, demandas y perspectivas de desarrollo que presentan los sectores productivos y sociales de la República Dominicana.
    
    e) Contribuir al bienestar social y a la igualdad de acceso al derecho a la educación superior de los ciudadanos y ciudadanas que deseen completar estudios superiores para su superación profesional.
  ...
  },
  {
    ...
    body: `Se crea una comisión ad hoc, de carácter interinstitucional, con la finalidad de acompañar, dar soporte y asistencia a la ejecución de las políticas del Sistema Nacional de Becas y Crédito de Apoyo Educativo, que estará conformada de la siguiente manera:
      ⦁	a) El Ministerio de Educación Superior, Ciencia y Tecnología, en su calidad de presidente del Consejo Nacional de Educación Superior, Ciencia y Tecnología, quien lo presidirá.
      ⦁	b) El Ministerio de Economía, Planificación y Desarrollo.
      ⦁	c) El Ministerio de Trabajo.
      ⦁	d) El Ministerio de Industria, Comercio y Mipymes.
      ⦁	e) El Ministerio de Relaciones Exteriores.
      ⦁	f) El Ministerio de la Juventud.
      ⦁	g) El director de la Oficina Gubernamental de Tecnología de la Información y la Comunicación
      ⦁	(OGTIC).
      ⦁	h) El director ejecutivo del Gabinete de Innovación.
      ⦁	i) Tres (3) representantes de los sectores productivos del país ligados a la educación superior, a propuesta del ministro de Educación Superior, Ciencia y Tecnología.
      `,
  },
  {
    id: 5,
  ...
  },
  {
    ...
    `,
    body: `Cada convocatoria de becas por universidad tiene requisitos específicos que debes revisar antes de tu proceso de aplicación. Todo lo podrás validar en el portal único de becas: becas.gob.do`,
  },
  {
    id: 11,
  ...
  },
  {
    ...
    `,
    body: `Todo el seguimiento lo podrás realizar en tiempo real a través de la plataforma becas.gob.do, de igual manera podrás recibir actualizaciones a tu celular por SMS y a tu correo electrónico.
    `,
  },
  {
    id: 15,
